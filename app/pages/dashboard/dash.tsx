              ...
              <div className="flex-1 px-4 flex justify-between sm:px-6 lg:max-w-6xl lg:mx-auto lg:px-8">
                ...
                <div className="ml-4 flex items-center md:ml-6">
                  <Menu as="div" className="ml-3 relative">
                    ...
                    >
                      <Menu.Items className="origin-top-right absolute right-0 mt-2 w-48 rounded-md shadow-lg py-1  ring-1 ring-black ring-opacity-5 focus:outline-none z-10">
                      ...
                      <p
                        className={classNames(
                          item.href === currentPath
                            ? "border-b border-gray-800 text-black"
                            : " hover:border-b hover:border-gray-800 text-gray-600 ",
